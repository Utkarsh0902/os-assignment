// GROUP 30
// Utkarsh jain 2018B5A70456H
// Arabelly Abhinav 2018B4AA0868H
// Abdul Razzak 2018B5AA1081H

// Shreya Manish Jambavalikar 2018B5A71089H
//Mushkan Sureka 2018B5A70477H
// Chowhan Tanmay Tushar 2018B5A71056H
// Soumit Mishra  2018B5A70429H
// Pritish moharir 2018B4A71024H
...
void* func1(void *arg){
    ...
    printf("Turn Around Time for C1 %ldus \n",end-parent_start);
...
void* func2(void *arg){
    ...
    printf("Turn Around Time for C2 %ldus \n",end-parent_start);
...
void* func3(void *arg){
    ...
    printf("Turn Around Time for C3 %ldus \n",end-parent_start);
